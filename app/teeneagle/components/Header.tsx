  ...
  return (
    <section className="bg-[#AFDDE5]">
      <div className="container">
        <div className="flex flex-col items-center justify-center h-[500px] md:h-screen text-center px-4">
          <h1
            className="text-[32px] sm:text-[40px] md:text-[46px] lg:text-[50px] xl:text-[54px] 2xl:text-[60px] 
            text-[#003135] font-bold md:max-w-2xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
