...
const Header = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: "url('/images/waicy/partners.jpg')",
      }}>
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col items-center justify-center min-h-[500px] lg:min-h-[600px] text-center px-4 py-20">
          ...
          <p
            ...
            Driven by a global network of hosts, collaborators, and partners
            <span className="text-white font-semibold">
              {" "}
              dedicated to advancing AI education for youth.
            </span>
          </p>
