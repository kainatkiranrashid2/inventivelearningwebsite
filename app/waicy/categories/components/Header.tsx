...
const Header = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: "url('/images/waicy/categories.jpg')",
      }}>
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col items-center justify-center min-h-[500px] lg:min-h-[600px] text-center px-4 py-20">
          ...
          <p
            ...
            Four exciting tracks to showcase your creativity, innovation, and AI
            skills.
            <span className="text-white font-semibold">
              {" "}
              Find the perfect fit for your talents.
            </span>
          </p>
